...
```bash
# 克隆仓库
git clone https://github.com/your-username/eino-skill-test.git

# 复制技能到本地目录
mkdir -p ~/.agents/skills/eino-skill
cp eino-skill-test/SKILL.md ~/.agents/skills/eino-skill/
cp -r eino-skill-test/references ~/.agents/skills/eino-skill/
```
